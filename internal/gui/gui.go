...
func StartServer(port int) error {
	...
	mux.HandleFunc("GET /crops/new", handleCropNewPage)
	mux.HandleFunc("POST /crops/new", handleCropNewAction)
	mux.HandleFunc("GET /crops/edit", handleCropEditPage)
	mux.HandleFunc("POST /crops/edit", handleCropEditAction)
